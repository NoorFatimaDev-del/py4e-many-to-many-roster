...
How to Run
Ensure you have the roster_data.json file in the same directory.

Run the script using Python: python roster.py.

The script will generate a rosterdb.sqlite file automatically.
